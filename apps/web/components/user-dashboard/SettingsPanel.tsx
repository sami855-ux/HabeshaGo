      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Configure account security, payments, alerts, and preferences in one
            place.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
          ...
          <CardContent className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>Default top-up method</Label>
              ...
              <SettingToggle
                ...
                title="Auto-recharge"
                description="Refill wallet automatically."
                enabled={toggles.autoRecharge}
                onChange={() => handleToggle("autoRecharge")}
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <SettingToggle
                ...
                title="Quick-pay"
                description="One-tap confirmation."
                enabled={toggles.quickPay}
                onChange={() => handleToggle("quickPay")}
              />
              <SettingToggle
                compact
                icon={<Smartphone className="size-4 text-primary" />}
                title="Offline QR (beta)"
                description="Future-ready tap & pay."
                enabled={toggles.offlineQr}
                onChange={() => handleToggle("offlineQr")}
              />
            </div>
        ...
        <Card className="border-0 shadow-md">
          <CardHeader>
            ...
            <CardDescription>Keep your journeys personalized.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-2">
